...
(function ($) {
    ...
    var control = {
        ...
        siteLoader: function () {
            ...
            // Safe fallback
            setTimeout(function () {
                if ($loader.length && !$loader.hasClass('done')) {
                    $loader.addClass("done");
                }
            }, 1000);
        },
        ...
        /*-----------------------------------------------------
            Event Filter js
        -----------------------------------------------------*/
        eventFilterAndGallery: function () { // Renamed and moved to a new function
            $(function () {
                $('.cat-filter').mixItUp();
            });
